...
export type CcSwitchUnavailableReason =
   ...
   * is the opposite: upgrade cc-switch, not cc-heihei.
   */
  | 'version-too-old'
...
export type CcSwitchScanOptions = {
  /** Saved cc-heihei providers, used for duplicate detection. */
 ...
 * appended. cc-heihei always appends (`${base}/v1/messages` and friends), so such
