...
describe('provider-aware thinking support', () => {
  ...
  beforeEach(() => {
    ...
    originalExplicitDisabledThinking = process.env.CC_HEIHEI_SEND_DISABLED_THINKING
  ...
  afterEach(() => {
    ...
    restoreEnv('CC_HEIHEI_SEND_DISABLED_THINKING', originalExplicitDisabledThinking)
  ...
  test('only sends explicit disabled thinking when the provider opts in', () => {
    delete process.env.CC_HEIHEI_SEND_DISABLED_THINKING
