...
const originalTranscriptEntrypoint = process.env.CC_HEIHEI_TRANSCRIPT_ENTRYPOINT
...
describe('sessionStorage flush', () => {
  ...
  afterEach(async () => {
    ...
    if (originalTranscriptEntrypoint === undefined) {
      delete process.env.CC_HEIHEI_TRANSCRIPT_ENTRYPOINT
    } else {
      process.env.CC_HEIHEI_TRANSCRIPT_ENTRYPOINT = originalTranscriptEntrypoint
    }
  ...
  it('records the desktop transcript entrypoint without changing the runtime entrypoint', async () => {
    ...
    process.env.CC_HEIHEI_TRANSCRIPT_ENTRYPOINT = 'claude-desktop'
    resetProjectForTesting()
  ...
  it('keeps desktop internal attachments and sdk-cli file attachments out of external transcripts', async () => {
    ...
    process.env.CC_HEIHEI_TRANSCRIPT_ENTRYPOINT = 'sdk-cli'
    resetProjectForTesting()
