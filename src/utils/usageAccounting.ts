 ...
 * cc-heihei is a multi-provider client, so a third-party model (glm, k3, deepseek, grok, gpt, ...)
 ...
 * malformed line. Deliberately does not reject an empty `model` the way ccusage does — cc-heihei
