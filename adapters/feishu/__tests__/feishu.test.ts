...
describe('Feishu: project picker card', () => {
  const sampleProjects: RecentProject[] = [
    {
      projectPath: '/Users/dev/claude-code-heihei',
      realPath: '/Users/dev/claude-code-heihei',
      projectName: 'claude-code-heihei',
      isGit: true,
      repoName: 'claude-code-heihei',
      branch: 'main',
  ...
  it('info column has title markdown + notation path markdown', () => {
    ...
    expect(info[0].content).toContain('**claude-code-heihei**')
    ...
    expect(info[1].content).toContain('claude-code-heihei')
  })
  ...
  it('row button says 选择 with small size and carries per-project value', () => {
    ...
    expect(btn1.value.realPath).toBe('/Users/dev/claude-code-heihei')
    expect(btn1.value.projectName).toBe('claude-code-heihei')
...
describe('Feishu: card.action.trigger parsing', () => {
  ...
  it('parses pick_project action from event', () => {
    ...
    expect(event.action.value.realPath).toBe('/Users/dev/claude-code-heihei')
    expect(event.action.value.projectName).toBe('claude-code-heihei')
  })
