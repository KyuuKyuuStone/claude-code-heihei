...
- **当前版本**：`v1.2.5`（2026-09-16 发布，Latest；v1.2.4 的安装包仍带三特性未接线半成品——H5 设置区 / 官方登录卡片 / cc-switch 导入，建议升级）
- **主分支**：`main`（上一发布 v1.2.4 = `af806c3`；v1.2.5 为本次发布提交）

## 当前状态

### 版本快照（v1.0.3 → v1.2.5，2026-09-07 ~ 09-16）
...
*当前版本：v1.2.5（Latest；上一发布 v1.2.4 = `af806c3`）*
