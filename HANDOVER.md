...
- **当前版本**：`v1.2.4`（2026-09-16 发布，Latest；v1.2.3 的安装包移除员工无痕迹、删除后身份缓存残留，建议升级）
- **主分支**：`main`（上一发布 v1.2.3 = `43e1683`；v1.2.4 为本次发布提交）

## 当前状态

### 版本快照（v1.0.3 → v1.2.4，2026-09-07 ~ 09-16）
...
*当前版本：v1.2.4（Latest；上一发布 v1.2.3 = `43e1683`）*
