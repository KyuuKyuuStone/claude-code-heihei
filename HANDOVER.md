...
- **当前版本**：`v1.2.3`（2026-09-16 发布，Latest；v1.2.2 的安装包仍会把系统事件注入对话流、打扰会话窗口，建议升级）
- **主分支**：`main`（上一发布 v1.2.2 = `2bef776`；v1.2.3 为本次发布提交）

## 当前状态

### 版本快照（v1.0.3 → v1.2.3，2026-09-07 ~ 09-16）
...
*当前版本：v1.2.3（Latest；上一发布 v1.2.2 = `2bef776`）*
