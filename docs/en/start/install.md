...
Everything lives on [GitHub Releases](https://github.com/KyuuKyuuStone/claude-code-heihei/releases/latest). Choose by operating system and CPU architecture:

| Your system | Download |
|---|---|
| macOS, Apple Silicon | `Claude-Code-Heihei-<version>-mac-arm64.dmg` |
| macOS, Intel | `Claude-Code-Heihei-<version>-mac-x64.dmg` |
| Windows x64 | `Claude-Code-Heihei-<version>-win-x64.exe` |
| Windows ARM64 | `Claude-Code-Heihei-<version>-win-arm64.exe` |
| Linux x64 | `Claude-Code-Heihei-<version>-linux-x86_64.AppImage` or `-linux-amd64.deb` |
| Linux ARM64 | `Claude-Code-Heihei-<version>-linux-arm64.AppImage` or `-linux-arm64.deb` |
...
1. Open the DMG.
2. Drag Claude Code Heihei into Applications.
...
```bash
xattr -dr com.apple.quarantine "/Applications/Claude Code Heihei.app"
```
...
```bash
chmod +x Claude-Code-Heihei-<version>-linux-x86_64.AppImage
./Claude-Code-Heihei-<version>-linux-x86_64.AppImage
```
...
```bash
sudo apt install ./Claude-Code-Heihei-<version>-linux-amd64.deb
```
