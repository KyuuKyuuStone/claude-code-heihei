---
title: What Claude Code Heihei is
...
Claude Code is Anthropic's command-line coding agent. The engine inside Claude Code Heihei is a CLI built from repaired Claude Code sources (it's called `claude-heihei` in this repo), and the desktop app is the graphical shell wrapped around it.
