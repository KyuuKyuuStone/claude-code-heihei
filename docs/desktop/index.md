...
- **左侧边栏**：品牌印章下面是「新建会话」「技能市场」，再往下是搜索条和你的项目、历史会话，最底部是「设置」。边界可以拖动改宽窄。
...
- [设置速查](./settings.md) — 各分栏一栏一段，包括主题、语言、代理、终端、MCP、Token 用量。
...
- [本地模型](./local-model.md) — 直接在本机跑 GGUF 大模型，无需联网、无需 API Key。
