...
所有安装包都在 [GitHub Releases](https://github.com/KyuuKyuuStone/claude-code-heihei/releases/latest)，按系统和 CPU 架构选一个：

| 你的系统 | 下载 |
|---|---|
| macOS，M 系列芯片 | `Claude-Code-Heihei-<版本>-mac-arm64.dmg` |
| macOS，Intel 芯片 | `Claude-Code-Heihei-<版本>-mac-x64.dmg` |
| Windows x64 | `Claude-Code-Heihei-<版本>-win-x64.exe` |
| Windows ARM64 | `Claude-Code-Heihei-<版本>-win-arm64.exe` |
| Linux x64 | `Claude-Code-Heihei-<版本>-linux-x86_64.AppImage` 或 `-linux-amd64.deb` |
| Linux ARM64 | `Claude-Code-Heihei-<版本>-linux-arm64.AppImage` 或 `-linux-arm64.deb` |
...
1. 双击 DMG。
2. 把 Claude Code Heihei 拖进「应用程序」。
3. 从「应用程序」打开。
...
```bash
chmod +x Claude-Code-Heihei-<版本>-linux-x86_64.AppImage
./Claude-Code-Heihei-<版本>-linux-x86_64.AppImage
```
...
```bash
sudo apt install ./Claude-Code-Heihei-<版本>-linux-amd64.deb
```
