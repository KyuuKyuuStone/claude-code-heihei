...
const BOUNDARY_CASES: Array<{ input: string; expected: string | null; why: string }> = [
  ...
  { input: 'https://github.com/KyuuKyuuStone/claude-code-heihei/issues/1145 里', expected: 'https://github.com/KyuuKyuuStone/claude-code-heihei/issues/1145', why: 'nested path' },
