...
export const DESKTOP_PERSISTENCE_VERSION_KEY = 'cc-heihei.persistence.schemaVersion'
...
const SESSION_RUNTIME_STORAGE_KEY = 'cc-heihei-session-runtime'
const THEME_STORAGE_KEY = 'cc-heihei-theme'
const FOLLOW_SYSTEM_THEME_STORAGE_KEY = 'cc-heihei-follow-system-theme'
const LIGHT_THEME_STORAGE_KEY = 'cc-heihei-light-theme'
const DARK_THEME_STORAGE_KEY = 'cc-heihei-dark-theme'
const LOCALE_STORAGE_KEY = 'cc-heihei-locale'
