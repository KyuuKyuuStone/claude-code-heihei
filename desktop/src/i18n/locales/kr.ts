...
export const kr: Record<TranslationKey, string> = {
  ...
  'settings.tab.localModel': '로컬 모델',
  'settings.localModel.title': '로컬 모델',
  'settings.localModel.subtitle': '이 기기에서 GGUF 모델을 직접 실행. 네트워크·API 키 불필요.',
  'settings.localModel.modelPath': '모델 파일',
  'settings.localModel.modelPathPlaceholder': '.gguf 모델 파일 선택',
  'settings.localModel.pickModel': '모델 선택',
  'settings.localModel.ctxSize': '컨텍스트 길이',
  'settings.localModel.ctxSizeDesc': '모델이 기억하는 대화 길이. 클수록 메모리 소모.',
  'settings.localModel.threads': 'CPU 스레드 수',
  'settings.localModel.nGpuLayers': 'GPU 레이어 수',
  'settings.localModel.nGpuLayersDesc': 'auto는 VRAM에 따라 GPU와 CPU를 자동 분배.',
  'settings.localModel.start': '시작',
  'settings.localModel.stop': '중지',
  'settings.localModel.state.stopped': '중지됨',
  'settings.localModel.state.starting': '시작 중…',
  ...
  'settings.terminal.description': '플러그인, 스킬, MCP 설정을 위해 호스트 컴퓨터의 명령을 실행합니다. 데스크톱 앱에는 claude-heihei가 포함되어 있습니다. 문서의 claude <args>를 claude-heihei <args>로 바꾸세요. 예: claude-heihei plugin install ... 또는 claude-heihei mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': '재설정 시 다음 항목만 제거합니다: cc-heihei-open-tabs, cc-heihei-session-runtime, cc-heihei-theme, cc-heihei-locale, cc-heihei-app-zoom, cc-heihei-ui-zoom, cc-heihei.persistence.schemaVersion.',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/cc-heihei/settings.json — 직접 편집할 수 있습니다. 저장 시 기록됩니다.',
  ...
  'settings.providers.ccSwitch.unavailableSchema': '이 cc-switch 버전은 cc-heihei가 아직 인식하지 못하는 구조로 설정을 저장합니다. cc-heihei를 업데이트하거나 공급자를 직접 추가하세요.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'cc-heihei 데이터용 폴더 선택',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code Heihei 알림이 사용 설정되었습니다',
  ...
  'settings.general.traceHintOn': '새 세션은 간결한 요청, 응답, 상태 이벤트를 로컬 cc-heihei traces 디렉터리에 기록합니다.',
  ...
  'repoLaunch.nonAsciiPathWarning': '작업 디렉터리 경로에 비 ASCII 문자(한글 등)가 포함되어 있습니다. 일부 툴체인에서 오류를 일으킬 수 있으니, 문제가 발생하면 ASCII 전용 경로로 변경하세요',
  'repoLaunch.nonAsciiPathWarningCompact': '비 ASCII 경로',
  ...
  'servant.modal.editTitle': '협업 설정',
  'servant.modal.role': '역할',
  'servant.modal.rolePlaceholder': '예: 백엔드 / 프론트엔드 / 작성',
  'servant.modal.serve': '다른 세션 지원',
  'servant.modal.serveHint': '슈퍼바이저 세션이 이 세션을 찾아 작업을 할당할 수 있습니다',
  'servant.modal.supervisor': '슈퍼바이저로 임명',
  'servant.modal.supervisorHint': '슈퍼바이저는 이 프로젝트의 작업자 세션에 작업을 할당합니다. 프로젝트당 1명',
  'sidebar.supervisorBadge': '슈퍼바이저',
    'sidebar.servantStatusTitle': '워커 상태: {status}',
    'sidebar.servantStatusBusy': '작업 중',
    'sidebar.servantStatusStalled': '대기',
  ...
  'sidebar.wakeFailed': '깨우기 실패, 서버 상태를 확인하세요',
    ...
    'servant.broadcast.title': '프로젝트 워커에게 브로드캐스트',
    'servant.broadcast.content': '브로드캐스트 내용',
    'servant.broadcast.placeholder': '예: 작업 중단 / 요구사항 변경, 현재 작업 일시 중지',
    'servant.broadcast.hint': '이 프로젝트의 모든 활성화된 워커 세션에 전송됩니다',
  'servant.modal.description': '역할 특성',
  'servant.modal.preset': '프리셋 역할',
  'servant.modal.presetPlaceholder': '프리셋으로 자동 입력하거나 아래에 직접 입력',
  'servant.presets.writer.name': '글쓰기',
  'servant.presets.writer.description': '보고서, 문서, 요약, 카피를 명확하고 절제된 문체로 작성하고 결과물을 Markdown 파일로 저장',
  'servant.presets.backend.name': '백엔드',
  'servant.presets.backend.description': '서버 개발과 API 설계. 실행 가능한 코드를 작성하고 스스로 검증하며 변경 전 영향을 설명',
  'servant.presets.frontend.name': '프론트엔드',
  'servant.presets.frontend.description': '페이지와 인터랙션 구현(HTML/CSS/JS 또는 프레임워크 컴포넌트). 디테일과 재현도를 중시하고 사용 가능하고 깔끔한 UI를 보장',
  'servant.presets.ue-developer.name': '언리얼 엔진 개발',
  'servant.presets.ue-developer.description': '언리얼 엔진(UE5) 게임플레이와 씬 개발. 블루프린트와 C++를 겸비하고 엔진 모범 사례를 따르며 컴파일 가능한 코드와 에셋 설명을 산출',
  'servant.presets.tester.name': '테스트',
  'servant.presets.tester.description': '테스트 작성과 실행, 기능 정확성 검증과 발견한 문제 보고. 재현 가능한 실제 문제만 보고',
  'servant.presets.illustrator.name': '일러스트레이터',
  'servant.presets.illustrator.description': '다양한 화풍으로 일러스트와 시각 소재를 그려 이미지 파일로 산출',
  'servant.presets.designer.name': '디자이너',
  'servant.presets.designer.description': '인터페이스와 비주얼 디자인. 디자인 시안, 레이아웃 시안, 스타일 가이드 산출',
  'servant.presets.data-analyst.name': '데이터 분석',
  'servant.presets.data-analyst.description': '데이터 처리와 분석. 결론, 통계표, 차트를 산출하고 결론에는 데이터 근거를 첨부',
  'servant.presets.planner.name': '기획',
  'servant.presets.planner.description': '요구사항 분해와 방안 기획. 구조화된 실행 가능한 계획 문서 산출',
  'servant.presets.reviewer.name': '코드 리뷰',
  'servant.presets.reviewer.description': '코드 품질, 보안, 유지보수성을 엄격하게 리뷰하고 실제 문제만 보고. 문제 목록과 수정 제안 산출',
  'servant.presets.translator.name': '번역',
  'servant.presets.translator.description': '중영 번역과 현지화. 용어 통일, 원문 어조 충실, 이중 언어 대조 파일 산출',
  'servant.presets.tech-writer.name': '기술 문서',
  'servant.presets.tech-writer.description': 'README, API 문서, 사용 가이드를 엄밀한 문장으로 작성하고 실행 가능한 예제를 담아 코드와 동기화 유지',
  'servant.presets.researcher.name': '리서치',
  'servant.presets.researcher.description': '자료를 검색해 기술 조사와 경쟁사 분석을 수행. 결론에는 반드시 출처를 첨부하고 인용이 포함된 조사 보고서 산출',
  'servant.presets.ops-scripter.name': '운영 스크립트',
  'servant.presets.ops-scripter.description': '배포와 문제 해결 스크립트를 신중하고 보수적으로 작성. 영향을 먼저 설명하고 실행하며 재사용 가능한 스크립트와 절차 목록 산출',
  'servant.presets.supervisor.description': '슈퍼바이저: 작업을 분해해 직원 세션에 배정하고 보고를 검수한 뒤 계속 배정. 직접 실행하지 않음',
  ...
  'servant.modal.constraintWhitelist': '디렉터리 화이트리스트(지정 디렉터리에만 쓰기 가능)',
  'servant.modal.writeDirs': '쓰기 가능 디렉터리(한 줄에 하나의 절대 경로)',
  'servant.modal.writeDirsPlaceholder': '한 줄에 하나의 절대 경로, 기본값은 세션 작업 디렉터리입니다',
  'servant.modal.writeDirsHint': '파일 쓰기 도구(Write/Edit/NotebookEdit)만 제한되며 Bash 명령은 이 화이트리스트의 적용 대상이 아닙니다. 제약 변경은 세션 재시작 후 적용됩니다',
