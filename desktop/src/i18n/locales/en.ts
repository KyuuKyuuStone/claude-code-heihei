export const en = {
  ...
  'settings.tab.localModel': 'Local Model',
  'settings.localModel.title': 'Local Model',
  'settings.localModel.subtitle': 'Run a GGUF model right on this machine — no network, no API key.',
  'settings.localModel.modelPath': 'Model file',
  'settings.localModel.modelPathPlaceholder': 'Choose a .gguf model file',
  'settings.localModel.pickModel': 'Choose model',
  'settings.localModel.ctxSize': 'Context window',
  'settings.localModel.ctxSizeDesc': 'How much conversation the model remembers; larger uses more memory.',
  'settings.localModel.threads': 'CPU threads',
  'settings.localModel.nGpuLayers': 'GPU layers',
  'settings.localModel.nGpuLayersDesc': 'auto splits across GPU and CPU based on available VRAM.',
  'settings.localModel.start': 'Start',
  'settings.localModel.stop': 'Stop',
  'settings.localModel.state.stopped': 'Stopped',
  'settings.localModel.state.starting': 'Starting…',
  ...
  'settings.terminal.description': 'Run host-machine commands for plugin, skill, and MCP setup. The desktop app includes claude-heihei; replace documented claude <args> with claude-heihei <args>, for example: claude-heihei plugin install ... or claude-heihei mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': 'Reset removes only: cc-heihei-open-tabs, cc-heihei-session-runtime, cc-heihei-theme, cc-heihei-locale, cc-heihei-app-zoom, cc-heihei-ui-zoom, and cc-heihei.persistence.schemaVersion.',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/cc-heihei/settings.json — edit directly, will be written on save.',
  ...
  'settings.providers.ccSwitch.unavailableSchema': 'This cc-switch version stores its configuration in a layout cc-heihei does not recognise yet. Update cc-heihei, or add the provider manually.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'Choose a folder for cc-heihei data',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code Heihei notifications are enabled',
  ...
  'settings.general.traceHintOn': 'New sessions write compact requests, responses, and status events to the local cc-heihei traces directory.',
  ...
  'repoLaunch.nonAsciiPathWarning': 'The working directory path contains non-ASCII characters (e.g. CJK), which can break some toolchains; if you hit issues, switch to a pure-ASCII path',
  ...
  'servant.modal.editTitle': 'Collaboration settings',
  'servant.modal.role': 'Role',
  'servant.modal.rolePlaceholder': 'e.g. Backend / Frontend / Writer',
  'servant.modal.serve': 'Serve other sessions',
  'servant.modal.serveHint': 'Allow a supervisor session to discover this session and assign work to it',
  'servant.modal.supervisor': 'Appoint as supervisor',
  'servant.modal.supervisorHint': 'Supervisors assign work to servant sessions in this project. One supervisor per project.',
  'sidebar.supervisorBadge': 'Supervisor',
    'sidebar.servantStatusTitle': 'Servant status: {status}',
    'sidebar.servantStatusBusy': 'Busy',
    'sidebar.servantStatusStalled': 'Waiting',
  ...
  'sidebar.wakeFailed': 'Wake failed, check server status',
    ...
    'servant.broadcast.title': 'Broadcast to project servants',
    'servant.broadcast.content': 'Broadcast content',
    'servant.broadcast.placeholder': 'e.g. Stand down / requirements changed, pause current task',
    'servant.broadcast.hint': 'Sent to every enabled servant session in this project',
  'servant.modal.description': 'Role description',
  'servant.modal.preset': 'Role preset',
  'servant.modal.presetPlaceholder': 'Pick a preset to autofill, or type your own below',
  'servant.presets.writer.name': 'Writing',
  'servant.presets.writer.description': 'Writes reports, documents, summaries and copy in a clear, restrained style; saves output as Markdown files',
  'servant.presets.backend.name': 'Backend',
  'servant.presets.backend.description': 'Server-side development and API design; writes runnable code and verifies it, explaining the impact before making changes',
  'servant.presets.frontend.name': 'Frontend',
  'servant.presets.frontend.description': 'Implements pages and interactions (HTML/CSS/JS or framework components) with care for detail and fidelity, keeping the UI usable and the styles tidy',
  'servant.presets.ue-developer.name': 'Unreal Engine Dev',
  'servant.presets.ue-developer.description': 'Unreal Engine (UE5) gameplay and scene development in both Blueprints and C++, following engine best practices and delivering compilable code and asset notes',
  'servant.presets.tester.name': 'Testing',
  'servant.presets.tester.description': 'Writes and runs tests, verifies correctness and reports findings; only reports real, reproducible issues',
  'servant.presets.illustrator.name': 'Illustrator',
  'servant.presets.illustrator.description': 'Draws illustrations and visual assets in a range of styles; delivers image files',
  'servant.presets.designer.name': 'Designer',
  'servant.presets.designer.description': 'UI and visual design; delivers design proposals, layout drafts and style guides',
  'servant.presets.data-analyst.name': 'Data Analysis',
  'servant.presets.data-analyst.description': 'Processes and analyzes data; delivers conclusions, statistical tables and charts, with data backing every conclusion',
  'servant.presets.planner.name': 'Planning',
  'servant.presets.planner.description': 'Breaks down requirements and plans solutions; delivers structured, actionable plan documents',
  'servant.presets.reviewer.name': 'Code Review',
  'servant.presets.reviewer.description': 'Reviews code quality, security and maintainability with a critical eye; only reports real issues, delivering a problem list with fix suggestions',
  'servant.presets.translator.name': 'Translation',
  'servant.presets.translator.description': 'Chinese-English translation and localization with consistent terminology and a tone faithful to the source; delivers bilingual side-by-side files',
  'servant.presets.tech-writer.name': 'Technical Writing',
  'servant.presets.tech-writer.description': 'Writes READMEs, API docs and usage guides with rigorous prose and runnable examples, kept in sync with the code',
  'servant.presets.researcher.name': 'Research',
  'servant.presets.researcher.description': 'Gathers sources for technical research and competitive analysis; every conclusion cites its source, delivering referenced research reports',
  'servant.presets.ops-scripter.name': 'Ops Scripting',
  'servant.presets.ops-scripter.description': 'Writes deployment and troubleshooting scripts conservatively, stating the impact before acting; delivers reusable scripts and step checklists',
  'servant.presets.supervisor.description': 'Supervisor: breaks down tasks, dispatches them to worker sessions, reviews their reports and keeps arranging; never executes hands-on',
  ...
  'servant.modal.constraintWhitelist': 'Directory whitelist (write only listed dirs)',
  'servant.modal.writeDirs': 'Writable directories (one absolute path per line)',
  'servant.modal.writeDirsPlaceholder': 'One absolute path per line; defaults to the session working directory',
  'servant.modal.writeDirsHint': 'Only file-writing tools (Write/Edit/NotebookEdit) are restricted; Bash commands are not covered by this whitelist. Constraint changes take effect after the session restarts',
