...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.localModel.downloadGuideDesc': '打开下载中心：GGUF 网站跳转、推荐模型与使用说明。',
...
第 9 行 全 8 格：接着上一行，从正下方继续向左转，经过左下、左边、左上，转回接近正上方`,
  ...
  'settings.pets.folderDescription': '自定义宠物包存储在这里：${CLAUDE_CONFIG_DIR:-~/.claude}/cc-heihei/pets',
  ...
  'servant.modal.descriptionPlaceholder': '用自然语言描述这个角色是什么，如"绘画师，擅长水彩风格插画"',
