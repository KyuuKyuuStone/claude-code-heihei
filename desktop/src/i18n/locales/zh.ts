...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.tab.localModel': '本地模型',
  'settings.localModel.title': '本地模型',
  'settings.localModel.subtitle': '在本机直接运行 GGUF 大模型，无需联网、无需 API Key。',
  'settings.localModel.modelPath': '模型文件',
  'settings.localModel.modelPathPlaceholder': '选择 .gguf 模型文件',
  'settings.localModel.pickModel': '选择模型',
  'settings.localModel.ctxSize': '上下文窗口',
  'settings.localModel.ctxSizeDesc': '模型能记住的对话长度，越大越占内存。',
  'settings.localModel.threads': 'CPU 线程数',
  'settings.localModel.nGpuLayers': 'GPU 层数',
  'settings.localModel.nGpuLayersDesc': 'auto 为按显存自动分配，GPU 与 CPU 混合使用。',
  'settings.localModel.start': '启动',
  'settings.localModel.stop': '停止',
  'settings.localModel.state.stopped': '未运行',
  'settings.localModel.state.starting': '启动中…',
  'settings.localModel.state.running': '运行中',
  'settings.localModel.state.error': '出错',
  'settings.localModel.downloadGuide': '下载模型',
  'settings.localModel.downloadGuideDesc': '打开下载中心：GGUF 网站跳转与使用说明。',
  'settings.localModel.logTitle': '引擎日志',
  ...
  'settings.terminal.description': '直接运行宿主机命令，用于安装插件、Skills、MCP 等扩展。桌面端已内置 claude-heihei；文档里的 claude <参数> 可替换成 claude-heihei <参数>，例如 claude-heihei plugin install ... 或 claude-heihei mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': '重置只会移除：cc-heihei-open-tabs、cc-heihei-session-runtime、cc-heihei-theme、cc-heihei-locale、cc-heihei-app-zoom、cc-heihei-ui-zoom 和 cc-heihei.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/cc-heihei/settings.json — 直接编辑，保存时写入。',
  ...
  'settings.providers.ccSwitch.unavailableSchema': '当前 cc-switch 版本的配置结构 cc-heihei 尚不认识。请更新 cc-heihei，或手动添加该服务商。',
  ...
  'settings.general.storagePortableDirPlaceholder': '选择一个用于保存 cc-heihei 数据的文件夹',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code Heihei 通知已启用',
  ...
  'settings.general.traceHintOn': '新会话会把精简请求、响应、状态事件写入本机 cc-heihei traces 目录。',
  ...
  'repoLaunch.nonAsciiPathWarning': '工作目录路径含非 ASCII 字符（如中文），部分工具链可能因此异常；如遇问题建议改用纯英文路径',
  'repoLaunch.nonAsciiPathWarningCompact': '非 ASCII 路径',
  ...
  'servant.modal.editTitle': '协作设置',
  'servant.modal.role': '角色',
  'servant.modal.rolePlaceholder': '如：后端 / 前端 / 写作',
  'servant.modal.serve': '服务其他会话',
  'servant.modal.serveHint': '允许主管会话发现此会话并向它派活',
  'servant.modal.supervisor': '任命为主管',
  'servant.modal.supervisorHint': '主管可以向本项目的员工会话派活。每个项目只能有一名主管',
  'sidebar.supervisorBadge': '主管',
    'sidebar.servantStatusTitle': '员工状态：{status}',
    'sidebar.servantStatusBusy': '忙碌',
    'sidebar.servantStatusStalled': '待命',
  ...
  'sidebar.wakeFailed': '唤醒失败，请检查服务状态',
    ...
    'servant.broadcast.title': '广播到本项目员工',
    'servant.broadcast.content': '广播内容',
    'servant.broadcast.placeholder': '例如：停工待命 / 需求变更，请暂停当前任务',
    'servant.broadcast.hint': '将发送给本项目全部启用状态的员工会话',
  'servant.modal.description': '角色特性',
  'servant.modal.preset': '预置角色',
  'servant.modal.presetPlaceholder': '选择预置自动填充，或在下方自行填写',
  'servant.presets.writer.name': '写作',
  'servant.presets.writer.description': '撰写报告、文档、总结与文案，行文清晰克制，产出保存为 Markdown 文件',
  'servant.presets.backend.name': '后端',
  'servant.presets.backend.description': '服务端开发与 API 设计，编写可运行的代码并自行验证，改动前先说明影响',
  'servant.presets.frontend.name': '前端',
  'servant.presets.frontend.description': '页面与交互实现（HTML/CSS/JS 或框架组件），注重细节与还原度，保证界面可用、样式整洁',
  'servant.presets.ue-developer.name': '虚幻引擎开发',
  'servant.presets.ue-developer.description': '虚幻引擎（UE5）玩法与场景开发，蓝图与 C++ 兼修，遵循引擎最佳实践，产出可编译的代码与资产说明',
  'servant.presets.tester.name': '测试',
  'servant.presets.tester.description': '编写与执行测试，验证功能正确性并报告发现的问题，只报可复现的真问题',
  'servant.presets.illustrator.name': '绘画师',
  'servant.presets.illustrator.description': '绘制插画与视觉素材，擅长多种绘画风格，产出图片文件',
  'servant.presets.designer.name': '设计师',
  'servant.presets.designer.description': '界面与视觉设计，输出设计方案、布局稿与样式规范',
  'servant.presets.data-analyst.name': '数据分析',
  'servant.presets.data-analyst.description': '处理与分析数据，输出结论、统计表格与图表，结论附带数据依据',
  'servant.presets.planner.name': '策划',
  'servant.presets.planner.description': '需求拆解与方案规划，输出结构化的可执行计划文档',
  'servant.presets.reviewer.name': '代码审查',
  'servant.presets.reviewer.description': '严格挑剔地审查代码质量、安全与可维护性，只报真问题，输出问题清单与修改建议',
  'servant.presets.translator.name': '翻译',
  'servant.presets.translator.description': '中英互译与本地化，术语一致、语气忠实原文，产出双语对照文件',
  'servant.presets.tech-writer.name': '技术文档',
  'servant.presets.tech-writer.description': '编写 README、API 文档与使用指南，行文严谨、示例可运行，与代码保持同步',
  'servant.presets.researcher.name': '调研分析',
  'servant.presets.researcher.description': '检索资料做技术调研与竞品分析，结论必须附带来源，产出带引用的调研报告',
  'servant.presets.ops-scripter.name': '运维脚本',
  'servant.presets.ops-scripter.description': '编写部署与排查脚本，谨慎保守，先说明影响再执行，产出可复用的脚本与步骤清单',
  'servant.presets.supervisor.description': '主管：分解任务、派给员工会话、验收汇报并继续安排，不经手具体执行',
  'servant.modal.descriptionPlaceholder': '用自然语言描述这个角色，可含行为风格，如"绘画师，严谨细腻，擅长水彩"',
  'servant.modal.descriptionHint': '派活时会随任务一起发给员工会话',
  'servant.modal.create': '创建',
  'servant.modal.sectionRole': '角色',
  'servant.modal.sectionRuntime': '运行配置',
  'servant.modal.sectionIdentity': '身份',
  'servant.modal.identityHint': '「服务其他会话」：允许主管发现此会话并派活；「任命为主管」：可向本项目员工派活，每个项目仅一名',
  'servant.modal.serveToggleHint': '关闭「服务其他会话」只是暂停接活：身份信息保留，可随时恢复。从花名册移除则协作身份终止，重新加入需重新登记。',
  'servant.modal.constraint': '约束档位',
  'servant.modal.constraintFull': '完全执行（可修改文件）',
  'servant.modal.constraintReadonly': '只读观察（禁改文件）',
  'servant.modal.constraintWhitelist': '目录白名单（仅可写指定目录）',
  'servant.modal.writeDirs': '可写目录（每行一个绝对路径）',
  'servant.modal.writeDirsPlaceholder': '每行一个绝对路径，默认为会话工作目录',
  'servant.modal.writeDirsHint': '仅限制文件写入类工具（Write/Edit/NotebookEdit），Bash 命令不受此白名单约束。修改档位将在会话重启后生效',
  'servant.modal.provider': '服务商',
  'servant.modal.model': '大模型',
  'servant.modal.effort': '思考强度',
  'servant.modal.runtimeHint': '员工会话将以此模型与思考强度无人值守运行，并以免审批（bypassPermissions）模式执行任务',
}
