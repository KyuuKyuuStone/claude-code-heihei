...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.localModel.subtitle': '在本機直接執行 GGUF 大模型，無需聯網、無需 API Key。',
  'settings.localModel.modelPath': '模型檔案',
  'settings.localModel.modelPathPlaceholder': '選擇 .gguf 模型檔案',
  'settings.localModel.pickModel': '選擇模型',
  'settings.localModel.ctxSize': '上下文窗口',
  'settings.localModel.ctxSizeDesc': '模型能記住的對話長度，越大越佔記憶體。',
  'settings.localModel.threads': 'CPU 執行緒數',
  'settings.localModel.nGpuLayers': 'GPU 層數',
  'settings.localModel.nGpuLayersDesc': 'auto 為按顯存自動分配，GPU 與 CPU 混合使用。',
  'settings.localModel.start': '啟動',
  'settings.localModel.stop': '停止',
  'settings.localModel.state.stopped': '未執行',
  'settings.localModel.state.starting': '啟動中…',
  ...
  'settings.terminal.description': '直接執行宿主機命令，用於安裝外掛、Skills、MCP 等擴充套件。桌面端已內建 claude-heihei；文件裡的 claude <引數> 可替換成 claude-heihei <引數>，例如 claude-heihei plugin install ... 或 claude-heihei mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': '重設只會移除：cc-heihei-open-tabs、cc-heihei-session-runtime、cc-heihei-theme、cc-heihei-locale、cc-heihei-app-zoom、cc-heihei-ui-zoom 和 cc-heihei.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/cc-heihei/settings.json — 直接編輯，儲存時寫入。',
  ...
  'settings.providers.ccSwitch.unavailableSchema': '目前 cc-switch 版本的設定結構 cc-heihei 尚未支援。請更新 cc-heihei，或手動新增該服務商。',
  ...
  'settings.general.storagePortableDirPlaceholder': '選擇一個用於儲存 cc-heihei 資料的資料夾',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code Heihei 通知已啟用',
  ...
  'settings.general.traceHintOn': '新會話會把精簡請求、回應、狀態事件寫入本機 cc-heihei traces 目錄。',
  ...
  'repoLaunch.nonAsciiPathWarning': '工作目錄路徑含非 ASCII 字元（如中文），部分工具鏈可能因此異常；如遇問題建議改用純英文路徑',
  'repoLaunch.nonAsciiPathWarningCompact': '非 ASCII 路徑',
  ...
  'servant.modal.editTitle': '協作設定',
  'servant.modal.role': '角色',
  'servant.modal.rolePlaceholder': '如：後端 / 前端 / 寫作',
  'servant.modal.serve': '服務其他會話',
  'servant.modal.serveHint': '允許主管會話發現此會話並向它派活',
  'servant.modal.supervisor': '任命為主管',
  'servant.modal.supervisorHint': '主管可以向本專案的員工會話派活。每個專案只能有一名主管',
  'sidebar.supervisorBadge': '主管',
    'sidebar.servantStatusTitle': '員工狀態：{status}',
    'sidebar.servantStatusBusy': '忙碌',
    'sidebar.servantStatusStalled': '待命',
  'sidebar.servantStatusWaiting': '待命中（等待下一個任務）',
    'sidebar.servantStatusIdle': '未執行',
  'sidebar.wakeServant': '喚醒員工（中斷並注入續跑提示）',
  'sidebar.wakeNudge': '你好，先前的任務因異常中斷了。請從當前進度繼續完成；如遇工具報錯，核心工具（Bash/Read/Write/Glob/Grep）本就內建可直接調用，無需用 ToolSearch 重新載入；確需載入其他延遲工具時再使用 select:（如 select:NotebookEdit,WebFetch）；完成後按規範向主管匯報。',
  'sidebar.wakeDone': '已發送喚醒指令',
  'sidebar.wakeFailed': '喚醒失敗，請檢查服務狀態',
    'sidebar.broadcastToServants': '廣播到本專案員工…',
    'servant.broadcast.title': '廣播到本專案員工',
    'servant.broadcast.content': '廣播內容',
    'servant.broadcast.placeholder': '例如：停工待命 / 需求變更，請暫停當前任務',
    'servant.broadcast.hint': '將發送給本專案全部啟用狀態的員工會話',
  'servant.modal.description': '角色特性',
  'servant.modal.preset': '預設角色',
  'servant.modal.presetPlaceholder': '選擇預設自動填入，或在下方自行填寫',
  'servant.presets.writer.name': '寫作',
  'servant.presets.writer.description': '撰寫報告、文件、總結與文案，行文清晰克制，產出儲存為 Markdown 檔案',
  'servant.presets.backend.name': '後端',
  'servant.presets.backend.description': '伺服端開發與 API 設計，撰寫可運行的程式碼並自行驗證，改動前先說明影響',
  'servant.presets.frontend.name': '前端',
  'servant.presets.frontend.description': '頁面與互動實作（HTML/CSS/JS 或框架元件），注重細節與還原度，保證介面可用、樣式整潔',
  'servant.presets.ue-developer.name': '虛幻引擎開發',
  'servant.presets.ue-developer.description': '虛幻引擎（UE5）玩法與場景開發，藍圖與 C++ 兼修，遵循引擎最佳實踐，產出可編譯的程式碼與資產說明',
  'servant.presets.tester.name': '測試',
  'servant.presets.tester.description': '撰寫與執行測試，驗證功能正確性並回報發現的問題，只報可重現的真問題',
  'servant.presets.illustrator.name': '繪畫師',
  'servant.presets.illustrator.description': '繪製插畫與視覺素材，擅長多種繪畫風格，產出圖片檔案',
  'servant.presets.designer.name': '設計師',
  'servant.presets.designer.description': '介面與視覺設計，輸出設計方案、版面稿與樣式規範',
  'servant.presets.data-analyst.name': '數據分析',
  'servant.presets.data-analyst.description': '處理與分析資料，輸出結論、統計表格與圖表，結論附帶資料依據',
  'servant.presets.planner.name': '策劃',
  'servant.presets.planner.description': '需求拆解與方案規劃，輸出結構化的可執行計畫文件',
  'servant.presets.reviewer.name': '程式碼審查',
  'servant.presets.reviewer.description': '嚴格挑剔地審查程式碼品質、安全與可維護性，只報真問題，輸出問題清單與修改建議',
  'servant.presets.translator.name': '翻譯',
  'servant.presets.translator.description': '中英互譯與在地化，術語一致、語氣忠實原文，產出雙語對照文件',
  'servant.presets.tech-writer.name': '技術文件',
  'servant.presets.tech-writer.description': '撰寫 README、API 文件與使用指南，行文嚴謹、範例可運行，與程式碼保持同步',
  'servant.presets.researcher.name': '調研分析',
  'servant.presets.researcher.description': '檢索資料做技術調研與競品分析，結論必須附帶來源，產出帶引用的調研報告',
  'servant.presets.ops-scripter.name': '維運腳本',
  'servant.presets.ops-scripter.description': '撰寫部署與排查腳本，謹慎保守，先說明影響再執行，產出可重用的腳本與步驟清單',
  'servant.presets.supervisor.description': '主管：分解任務、派給員工會話、驗收匯報並繼續安排，不經手具體執行',
  ...
  'servant.modal.constraintWhitelist': '目錄白名單（僅可寫指定目錄）',
  'servant.modal.writeDirs': '可寫目錄（每行一個絕對路徑）',
  'servant.modal.writeDirsPlaceholder': '每行一個絕對路徑，預設為會話工作目錄',
  'servant.modal.writeDirsHint': '僅限制檔案寫入類工具（Write/Edit/NotebookEdit），Bash 指令不受此白名單約束。修改檔位將在工作階段重啟後生效',
