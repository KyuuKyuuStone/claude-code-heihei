...
export const jp: Record<TranslationKey, string> = {
  ...
  'settings.tab.localModel': 'ローカルモデル',
  'settings.localModel.title': 'ローカルモデル',
  'settings.localModel.subtitle': 'GGUF モデルをこのマシンで直接実行。ネットワークも API キーも不要。',
  'settings.localModel.modelPath': 'モデルファイル',
  'settings.localModel.modelPathPlaceholder': '.gguf モデルファイルを選択',
  'settings.localModel.pickModel': 'モデルを選択',
  'settings.localModel.ctxSize': 'コンテキスト長',
  'settings.localModel.ctxSizeDesc': 'モデルが覚えている会話の長さ。大きいほどメモリを消費。',
  'settings.localModel.threads': 'CPU スレッド数',
  'settings.localModel.nGpuLayers': 'GPU レイヤー数',
  'settings.localModel.nGpuLayersDesc': 'auto は VRAM に応じて GPU と CPU を自動分割。',
  'settings.localModel.start': '開始',
  'settings.localModel.stop': '停止',
  'settings.localModel.state.stopped': '停止中',
  'settings.localModel.state.starting': '起動中…',
  ...
  'settings.terminal.description': 'プラグイン、スキル、MCP のセットアップ用にホストマシンのコマンドを実行します。デスクトップアプリには claude-heihei が含まれています。ドキュメントの claude <args> を claude-heihei <args> に置き換えてください。例: claude-heihei plugin install ... や claude-heihei mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': 'リセットで削除されるのは次のみ: cc-heihei-open-tabs、cc-heihei-session-runtime、cc-heihei-theme、cc-heihei-locale、cc-heihei-app-zoom、cc-heihei-ui-zoom、cc-heihei.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/cc-heihei/settings.json — 直接編集できます。保存時に書き込まれます。',
  ...
  'settings.providers.ccSwitch.unavailableSchema': 'この cc-switch のバージョンは cc-heihei がまだ認識できない構造で設定を保存しています。cc-heihei を更新するか、手動でプロバイダーを追加してください。',
  ...
  'settings.general.storagePortableDirPlaceholder': 'cc-heihei データ用のフォルダを選択',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code Heihei の通知が有効になりました',
  ...
  'settings.general.traceHintOn': '新しいセッションは、簡潔な要求、応答、状態イベントをローカルの cc-heihei traces ディレクトリに書き込みます。',
  ...
  'repoLaunch.nonAsciiPathWarning': '作業ディレクトリのパスに非 ASCII 文字（日本語など）が含まれています。一部のツールチェーンで異常を招くことがあります。問題が出た場合は ASCII のみのパスへの変更をおすすめします',
  'repoLaunch.nonAsciiPathWarningCompact': '非 ASCII パス',
  ...
  'servant.modal.editTitle': 'コラボ設定',
  'servant.modal.role': 'ロール',
  'servant.modal.rolePlaceholder': '例：バックエンド / フロントエンド / ライター',
  'servant.modal.serve': '他のセッションにサービス',
  'servant.modal.serveHint': 'スーパーバイザーセッションがこのセッションを見つけて作業を割り当てられるようにします',
  'servant.modal.supervisor': 'スーパーバイザーに任命',
  'servant.modal.supervisorHint': 'スーパーバイザーはこのプロジェクトのワーカーセッションに作業を割り当てます。1プロジェクトにつき1名',
  'sidebar.supervisorBadge': '主管',
    'sidebar.servantStatusTitle': 'ワーカー状態：{status}',
    'sidebar.servantStatusBusy': '実行中',
    'sidebar.servantStatusStalled': '待機中',
  ...
  'sidebar.wakeFailed': '起床に失敗しました。サーバー状態を確認してください',
    ...
    'servant.broadcast.title': 'ワーカー全員へブロードキャスト',
    'servant.broadcast.content': 'ブロードキャスト内容',
    'servant.broadcast.placeholder': '例：作業停止 / 要件変更のため現在のタスクを一時停止',
    'servant.broadcast.hint': 'このプロジェクトの有効なワーカーセッションすべてに送信されます',
  'servant.modal.description': 'ロールの特性',
  'servant.modal.preset': 'プリセットロール',
  'servant.modal.presetPlaceholder': 'プリセットで自動入力、または下に直接入力',
  'servant.presets.writer.name': 'ライティング',
  'servant.presets.writer.description': 'レポート・ドキュメント・要約・コピーを簡潔で明確な文体で執筆し、Markdown ファイルとして保存する',
  'servant.presets.backend.name': 'バックエンド',
  'servant.presets.backend.description': 'サーバーサイド開発と API 設計。動作するコードを書き自ら検証し、変更前に影響を説明する',
  'servant.presets.frontend.name': 'フロントエンド',
  'servant.presets.frontend.description': 'ページとインタラクションの実装（HTML/CSS/JS またはフレームワークのコンポーネント）。細部と再現度を重視し、使いやすく整った UI を保証する',
  'servant.presets.ue-developer.name': 'Unreal Engine 開発',
  'servant.presets.ue-developer.description': 'Unreal Engine（UE5）のゲームプレイとシーン開発。ブループリントと C++ を使い分け、エンジンのベストプラクティスに従い、コンパイル可能なコードとアセット説明を納品する',
  'servant.presets.tester.name': 'テスト',
  'servant.presets.tester.description': 'テストの作成と実行、機能の正しさを検証して問題を報告する。再現可能な真の問題のみ報告する',
  'servant.presets.illustrator.name': 'イラストレーター',
  'servant.presets.illustrator.description': '多彩な画風でイラストやビジュアル素材を描き、画像ファイルを納品する',
  'servant.presets.designer.name': 'デザイナー',
  'servant.presets.designer.description': 'インターフェースとビジュアルのデザイン。設計案・レイアウト案・スタイルガイドを納品する',
  'servant.presets.data-analyst.name': 'データ分析',
  'servant.presets.data-analyst.description': 'データを処理・分析し、結論・統計表・グラフを納品する。結論にはデータの根拠を添える',
  'servant.presets.planner.name': '企画',
  'servant.presets.planner.description': '要件の分解と方策の計画。構造化された実行可能な計画書を納品する',
  'servant.presets.reviewer.name': 'コードレビュー',
  'servant.presets.reviewer.description': 'コードの品質・安全性・保守性を厳しくレビューし、真の問題のみ報告する。問題リストと修正提案を納品する',
  'servant.presets.translator.name': '翻訳',
  'servant.presets.translator.description': '中英翻訳とローカライズ。用語を統一し原文の語調を忠実に保ち、バイリンガル対訳ファイルを納品する',
  'servant.presets.tech-writer.name': '技術ドキュメント',
  'servant.presets.tech-writer.description': 'README・API ドキュメント・利用ガイドを厳密な文体で執筆し、実行可能な例を載せ、コードとの同期を保つ',
  'servant.presets.researcher.name': '調査分析',
  'servant.presets.researcher.description': '資料を検索して技術調査と競合分析を行う。結論には必ず出典を添え、引用付きの調査レポートを納品する',
  'servant.presets.ops-scripter.name': '運用スクリプト',
  'servant.presets.ops-scripter.description': 'デプロイとトラブルシューティングのスクリプトを慎重に書く。影響を説明してから実行し、再利用可能なスクリプトと手順リストを納品する',
  'servant.presets.supervisor.description': 'スーパーバイザー：タスクを分解してワーカーセッションに割り当て、報告を検収して次を手配する。自ら手を動かさない',
  ...
  'servant.modal.constraintWhitelist': 'ディレクトリホワイトリスト（指定ディレクトリのみ書き込み可）',
  'servant.modal.writeDirs': '書き込み可能ディレクトリ（1行に1つの絶対パス）',
  'servant.modal.writeDirsPlaceholder': '1行に1つの絶対パス。既定はセッションの作業ディレクトリです',
  'servant.modal.writeDirsHint': 'ファイル書き込みツール（Write/Edit/NotebookEdit）のみ制限され、Bash コマンドはこのホワイトリストの対象外です。制約の変更はセッション再起動後に有効になります',
