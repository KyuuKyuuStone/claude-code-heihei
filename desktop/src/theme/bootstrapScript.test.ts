...
function seedStorage(stored: {
  ...
  if (stored.theme !== undefined) window.localStorage.setItem('cc-heihei-theme', stored.theme)
  if (stored.follow !== undefined) window.localStorage.setItem('cc-heihei-follow-system-theme', stored.follow)
  if (stored.lightTheme !== undefined) window.localStorage.setItem('cc-heihei-light-theme', stored.lightTheme)
  if (stored.darkTheme !== undefined) window.localStorage.setItem('cc-heihei-dark-theme', stored.darkTheme)
}
