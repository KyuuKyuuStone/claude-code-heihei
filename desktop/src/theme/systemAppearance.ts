...
export const THEME_STORAGE_KEY = 'cc-heihei-theme'
export const FOLLOW_SYSTEM_THEME_STORAGE_KEY = 'cc-heihei-follow-system-theme'
export const LIGHT_THEME_STORAGE_KEY = 'cc-heihei-light-theme'
export const DARK_THEME_STORAGE_KEY = 'cc-heihei-dark-theme'
