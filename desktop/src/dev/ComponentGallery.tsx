...
export function ComponentGallery() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)] px-8 py-6 text-[var(--color-text-primary)]">
      ...
      <Section title="BrandSeal" note="The cc-heihei mark, a vector rebuild of the app icon. It sheds parts as it shrinks — sparkles only at xl, cursor drops at sm — so check each size against its neighbours.">
