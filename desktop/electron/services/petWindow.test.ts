...
describe('Electron pet window service', () => {
  ...
  it('persists position only in the app-owned cc-heihei config root', () => {
    const root = mkdtempSync(path.join(tmpdir(), 'cc-heihei-pet-position-'))
  ...
  it('persists the mascot box with the position and tolerates state without one', () => {
    const root = mkdtempSync(path.join(tmpdir(), 'cc-heihei-pet-region-'))
